...
// portfolio Row
// $('body').unbind('click').bind('click','.add-portfolio-row',function(){
  $('body').on('click','.add-portfolio-row',function(e){
    // $(".add-portfolio-row").click(function(e) {
      e.preventDefault();
      var uniqueID = Date.now().toString(36) + Math.random().toString(36).substring(2);
    // $(".add-portfolio-row").click(function(){
  console.log('add portfolio');
  var newRow = '';
  newRow += '<div class="row addportfolio">';
    newRow += '<div class="col-lg-12">';
      newRow += '<div class="info-title">';
        newRow += '<h6>Add Your Portfolio:</h6>';
        newRow += '<div class="dash"></div>';
      newRow += '</div>';
    newRow += '</div>';
  ...
  newRow += '<div class="col-md-12">';
    newRow += '<div class="form-inner mb-20">';
      newRow += '<label>Description*</label>';
      newRow += '<textarea name="description" placeholder="Portfolio Description"></textarea>';
    newRow += '</div>';
  newRow += '</div>';

  newRow += '<div class="col-md-12">';
  newRow += '<div class="form-inner mb-20">';
    newRow += '<label>Images*</label>';
    newRow += '<input type="text" name="companies" placeholder="Portfolio Images">';
  newRow += '</div>';
  newRow += '</div>';

  newRow += '<div class="add-row">';
  newRow += '<button type="button" class="remove-experiences-row remove">Remove Portfolio</button>'
newRow += "</div>";
  newRow += '</div>';
  $('.portfolio-row').append(newRow);
    $('.select1').niceSelect();
